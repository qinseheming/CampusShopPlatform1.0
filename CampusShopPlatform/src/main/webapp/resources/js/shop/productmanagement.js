$(function() {
	// 获取此店铺下的商品列表的URL
	var listUrl = '/CampusShopPlatform/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
	// 商品下架URL
	var statusUrl = '/CampusShopPlatform/shopadmin/modifyproduct';
	getList();
	/**
	 * 获取此店铺下的商品列表
	 * 
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							...
							window.location.href = '/CampusShopPlatform/shopadmin/productoperation?productId='
							...
							window.location.href = '/CampusShopPlatform/frontend/productdetail?productId='
									+ e.currentTarget.dataset.id;
						}
					});
