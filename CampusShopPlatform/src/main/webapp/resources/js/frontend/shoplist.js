$(function() {
	...
	var pageSize = 3;
	// 获取店铺列表的URL
	var listUrl = '/CampusShopPlatform/frontend/listshops';
	// 获取店铺类别列表以及区域列表的URL
	var searchDivUrl = '/CampusShopPlatform/frontend/listshopspageinfo';
	// 页码
	var pageNum = 1;
	...
	$('.shop-list').on('click', '.card', function(e) {
		...
		window.location.href = '/CampusShopPlatform/frontend/shopdetail?shopId=' + shopId;
	});
